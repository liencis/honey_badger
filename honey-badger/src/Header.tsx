...
function Header({ gameOver }: HeaderProps) {
  ...
  useEffect(() => {
    if (gameOver === true) {
      setTimeout(() => {
        setLogPic(badger_sad);
      }, 750);
      setTimeout(() => {
        setLogPic(badger_sad_2);
      }, 860);
      setTimeout(() => {
        setLogPic(badger_sad_3);
      }, 920);
      setTimeout(() => {
        setLogPic(badger_sad_4);
      }, 980);
      setTimeout(() => {
        setLogPic(badger_sad_5);
      }, 1040);
      setTimeout(() => {
        setLogPic(badger_sad_6);
      }, 1100);
      setTimeout(() => {
        setLogPic(badger_sad_7);
      }, 1160);
      setTimeout(() => {
        setLogPic(badger_sad_8);
      }, 1220);
      setTimeout(() => {
        setLogPic(badger_sad_9);
      }, 1280);
      setTimeout(() => {
        setLogPic(badger_sad_10);
      }, 1340);
      setTimeout(() => {
        setLogPic(badger_sad_final);
      }, 1400);
    } else {
